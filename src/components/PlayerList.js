...
function PlayerList() {
  ...
  return (
    ...
    overflow: "hidden",     // prevent overflow outside box
    textOverflow: "ellipsis" // add "..." if too long
  }}
                >{`${p.firstName} ${p.lastName}`}</strong>
                <div
                  style={{
                    fontSize: "0.7rem",
                    color: "#666",
        ...
        <div style={overlayStyle}>
          <div style={dialogStyle}>
            ...
            <input
              ...
              style={{
                borderColor:
                  touched.firstName && !form.firstName.trim() ? "red" : null,
                borderWidth:
                  touched.firstName && !form.firstName.trim() ? "2px" : null,
              }}
            />
            <input
              ...
              style={{
                borderColor:
                  touched.lastName && !form.lastName.trim() ? "red" : null,
                borderWidth:
                  touched.lastName && !form.lastName.trim() ? "2px" : null,
              }}
            />
            <select
              value={form.gender}
